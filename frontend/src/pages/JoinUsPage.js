...
export const JoinUsPage = ({ language, isDark }) => {
  ...
  const eyebrowClass = 'text-orange-500 text-xs font-semibold uppercase tracking-[0.22em]';
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 py-28 sm:py-32 relative z-10">
        ...
        <PageHeader
          ...
          title={language === 'EN' ? 'Join Us' : '参加する'}
        ...
        >
          <p className={`text-base leading-relaxed ${bodyClass}`}>
            {language === 'EN'
              ...
              : "荒井グループは一つの指針となる問いに導かれています：量子科学を脆弱な研究室内の探求から、社会のための共有された知的・技術的インフラへと変革するにはどうすればよいか？私たちの研究室は、基礎物理学、量子デバイス、材料、実世界への応用が交差する領域で活動し、堅牢で実用的、かつ社会的インパクトのある成果に向けて量子科学を推進しています。"
            }
          </p>
          <div className={`mt-6 rounded-2xl p-6 ${cardClass}`}>
            <p className={`text-base italic ${bodyClass}`}>
              {language === 'EN'
        ...
        <motion.div
          ...
          className={`rounded-2xl p-8 mb-12 ${cardClass}`}
        >
          <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight mb-6 ${headingClass}`}>
        ...
        >
          <div className="flex items-center mb-6">
            <GraduationCap className="text-orange-500 mr-4 flex-shrink-0" size={28} />
            <div>
              <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${headingClass}`}>
          ...
          <div className="space-y-6">
            <div>
              <h3 className={`text-lg sm:text-xl font-semibold tracking-tight mb-3 flex items-center ${headingClass}`}>
                <Target className="text-orange-500 mr-2 flex-shrink-0" size={20} />
                {language === 'EN' ? 'Who we are looking for' : '私たちが求める人物'}
              </h3>
              <p className={`mb-4 leading-relaxed ${bodyClass}`}>
                {language === 'EN'
              ...
              <div className={`mb-4 ${bodyClass}`}>
                <p className={`font-semibold mb-2 ${headingClass}`}>
              ...
              <div className="rounded-2xl p-6 bg-orange-500/10 border border-orange-500/30">
                <p className="text-sm font-semibold mb-1 text-orange-500">
            ...
            <div>
              <h3 className={`text-lg sm:text-xl font-semibold tracking-tight mb-3 flex items-center ${headingClass}`}>
                <TrendingUp className="text-orange-500 mr-2 flex-shrink-0" size={20} />
        ...
        >
          <div className="flex items-center mb-6">
            <BookOpen className="text-orange-500 mr-4 flex-shrink-0" size={28} />
            <div>
              <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${headingClass}`}>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className={`mt-4 leading-relaxed ${bodyClass}`}>
                {language === 'EN'
            ...
            <div>
              ...
              <ul className={`space-y-3 ${bodyClass}`}>
                {(language === 'EN' ? [
                  ...
                  'コンサルティング手法に学んだプロジェクト管理：課題定義、仮説、マイルストーン、KPIに基づく',
                  '出版レベルの研究スキル：図を論理に、論理を物語に、物語を論文に変える',
                  '産業界やスタートアップとの直接的な連携（日本・海外）：半導体・量子企業、ディープテックスタートアップ、スピンオフエコシステム',
                  '物理学、デバイス・材料、データ駆動型手法を一つのプロジェクト内で統合する能力',
                  '海外での研究機会や国際会議・ワークショップでの発表機会'
                ]).map((item, idx) => (
                  <li key={idx} className="flex items-start">
                    <div className="w-1.5 h-1.5 bg-orange-500 rounded-full mr-3 mt-2 flex-shrink-0" />
                    <span>{item}</span>
        ...
        >
          <div className="flex items-center mb-6">
            <Award className="text-orange-500 mr-4 flex-shrink-0" size={28} />
            <div>
              <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${headingClass}`}>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className={`space-y-2 mb-4 ${bodyClass}`}>
                {(language === 'EN' ? [
            ...
            <div>
              ...
              <p className={`mt-4 font-semibold ${headingClass}`}>
                {language === 'EN'
        ...
        >
          <div className="flex items-center mb-6">
            <Users className="text-orange-500 mr-4 flex-shrink-0" size={28} />
            <div>
              <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${headingClass}`}>
        ...
        >
          <div className="flex items-center mb-6">
            <Globe className="text-orange-500 mr-4 flex-shrink-0" size={28} />
            <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${headingClass}`}>
              {language === 'EN' ? 'For International Applicants' : '国際出願者の方へ'}
            </h2>
          </div>

          <p className={`mb-6 leading-relaxed ${bodyClass}`}>
            {language === 'EN'
          ...
          <div className="space-y-6">
            <div>
              <h3 className={`text-lg sm:text-xl font-semibold tracking-tight mb-3 ${headingClass}`}>
              ...
              <a
                ...
                className="inline-flex items-center text-orange-500 hover:text-orange-400 font-medium mb-4 transition-colors"
              >
            ...
            <div>
              ...
              <p className={`mb-3 leading-relaxed ${bodyClass}`}>
                {language === 'EN'
        ...
        >
          <div className="flex items-center mb-6">
            <MessageCircle className="text-orange-500 mr-4 flex-shrink-0" size={28} />
            <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${headingClass}`}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className={`space-y-2 mb-6 ${bodyClass}`}>
                {(language === 'EN' ? [
                  'Your CV (any format)',
        ...
        >
          <div className="flex items-center mb-6">
            <HelpCircle className="text-orange-500 mr-4 flex-shrink-0" size={28} />
            <h2 className={`text-2xl sm:text-3xl font-semibold tracking-tight ${headingClass}`}>
          ...
          <div className="space-y-6">
            {(language === 'EN' ? [
              ...
              <div key={idx}>
                <h3 className={`text-lg font-semibold tracking-tight mb-2 ${headingClass}`}>
                  Q: {faq.q}
                </h3>
