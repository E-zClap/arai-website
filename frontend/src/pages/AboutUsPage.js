  ...
  const missionActions = [
    {
      ...
      description: {
        ...
        JP: "実験、理論、データ駆動型手法を統合し、量子センシング、量子計量学、量子デバイス、量子情報処理の次世代基盤技術を創造します。（ダイヤモンド量子エレクトロニクスはこの広範なアジェンダの中核テーマの1つです。）"
      }
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: {
        ...
        JP: "世界の主要機関との対等な協力関係と研究者交流を発展させ、日本発のテーマと実験能力が国際プロジェクトで中心的な役割を果たすことができるようにします。"
      }
    },
    {
      icon: Building,
    ...
    },
    {
      ...
      description: {
        ...
        JP: "子供、学生、市民、企業が量子技術の興奮と可能性をアクセスしやすい方法で体験し、量子を自分の未来に直接関連するものとして考える機会を創出します。"
      }
    }
  ];
        ...
        >
          ...
          <div className={`backdrop-blur-lg rounded-3xl p-10 border mb-10 ${
            ...
            <p className={`text-lg ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              {language === 'EN'
                ? 'We pursue this vision along three research directions:'
