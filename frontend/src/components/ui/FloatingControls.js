  ...
  return (
    <div className="fixed right-6 top-1/2 -translate-y-1/2 z-40 space-y-4">
      ...
      <motion.button
        ...
        className={`w-14 h-14 rounded-2xl transition-all duration-300 group ${
          isDark 
            ? 'bg-slate-800/80 border-slate-600/50 text-yellow-400 hover:bg-slate-700/90' 
      ...
      <motion.button
        ...
        className={`w-14 h-14 rounded-2xl transition-all duration-300 group ${
          isDark 
            ? 'bg-slate-800/80 border-slate-600/50 text-cyan-400 hover:bg-slate-700/90' 
            : 'bg-white border-slate-200/50 text-slate-600 hover:bg-gray-50 shadow-lg'
        } border backdrop-blur-xl flex items-center justify-center`}
      ...
      >
        <div className="flex flex-col items-center">
          <Globe size={16} className="mb-0.5 group-hover:rotate-180 transition-transform duration-500" />
      ...
      <motion.div
        className={`w-14 h-14 rounded-2xl transition-all duration-300 ${
          isDark 
            ? 'bg-slate-800/80 border-slate-600/50 text-teal-400' 
            : 'bg-white border-slate-200/50 text-teal-600 shadow-lg'
        } border backdrop-blur-xl flex items-center justify-center cursor-help`}
        whileHover={{ scale: 1.05, rotate: -5 }}
        title="Tokyo Institute of Technology - Quantum Sensing Laboratory"
      >
