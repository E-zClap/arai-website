    ...
    >
      ...
      <div className="space-y-4">
        {link ? (
          <a 
            href={link}
            className="block p-4 bg-dark-gray-850/40 rounded-2xl border border-slate-700/50 hover:border-orange-500/40 text-orange-300 hover:text-white transition-all duration-300 group-hover:bg-dark-gray-800/50"
          >
