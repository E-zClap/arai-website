...
export const publicationCategories = [
  {
    id: "all",
    label: { EN: "All Publications", JP: "すべての論文" },
    count: publicationsData.length
  },
  {
    id: "quantum-sensing",
    label: { EN: "Quantum Sensing", JP: "量子センシング" },
    count: publicationsData.filter(p => p.category === "Quantum Sensing").length
  },
  {
    id: "quantum-control",
    label: { EN: "Quantum Control", JP: "量子制御" },
